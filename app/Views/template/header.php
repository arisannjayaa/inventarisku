            ...
            <div class="sidebar-wrapper active">
                <div class="sidebar-header position-relative">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="logo">
                            <a href="index.html">InventarisKu</a>
                        </div>
                        <div class="theme-toggle d-none gap-2  align-items-center">
                        ...
                        <li class="sidebar-item  has-sub">
                            ...
                            <ul class="submenu ">
                                <li class="submenu-item ">
                                    <a href="component-alert.html">Data Barang</a>
                                </li>
                                <li class="submenu-item ">
                                    <a href="component-badge.html">Data Jurusan</a>
                                </li>
                                <li class="submenu-item ">
                                    <a href="component-badge.html">Data Prodi</a>
                                </li>
                            </ul>
                        </li>
                                    ...
                                    <div class="user-menu d-flex">
                                        ...
                                        <div class="user-img d-flex align-items-center">
                                            <div class="avatar avatar-md">
                                                <img src="<?= base_url('') ?>/dist/assets/images/faces/1.jpg">
                                            </div>
                                        </div>
                                    </div>
                                </a>
